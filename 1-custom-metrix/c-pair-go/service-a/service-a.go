...
// generate500KBData 생성: prefix를 반복하여 1KB 문자열을 만듭니다.
func generate500KBData(prefix string) string {
	return strings.Repeat(prefix, 1024*100)
}
